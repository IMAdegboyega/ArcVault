...
const Sidebar = ({ user }: SiderbarProps) => {
  ...
  return (
    <section className="sticky left-0 top-0 hidden h-screen w-[72px] flex-col justify-between border-r border-gray-100 bg-white md:flex xl:w-[264px]">
      {/* Logo */}
      <div>
        <Link href="/" className="flex items-center gap-2.5 px-5 py-7 xl:px-6">
          ...
          <h1 className="hidden text-[22px] font-bold font-ibm-plex-serif text-gray-900 xl:block">
            ArcVault
          </h1>
        </Link>
